...
int main() // all comunicates shown to the user are written in Polish since this is supposed to be a currency exchange in Poland
{
    ...
    while (run)
    {
        ...
        if(inp_msg == "sprzedaj")
        {
            ...
            std::cout<<av_curr<<"Jaką walutę chcesz sprzedać?\n";
            std::cin>>currency;
            std::cout<<"Ile odpowiedników złotówki chcesz sprzedać?\n";
            std::cin>>am_big_ones;
            ...
            std::cout<<"Ile odpowiedników groszy chcesz sprzedać?\n";
        ...
        else if(inp_msg == "kup")
        {
            std::string currency;
            int am_big_ones, am_small_ones;
            std::cout<<av_curr<<"Jaką walutę chcesz kupić?\n";
            std::cin>>currency;
            std::cout<<"Ile odpowiedników złotówki chcesz kupić?\n";
            std::cin>>am_big_ones;
            if(std::cin.fail() || am_big_ones<0)
            {
                std::cout<<"Podano niewłaściwą ilość odpwiedników złotówek\n";
            ...
            std::cout<<"Ile odpowiedników groszy chcesz kupić?\n";
            std::cin>>am_small_ones;
            if(std::cin.fail() || am_small_ones<0)
            {
                std::cout<<"Podano niewłaściwą ilość odpwiedników groszy\n";
